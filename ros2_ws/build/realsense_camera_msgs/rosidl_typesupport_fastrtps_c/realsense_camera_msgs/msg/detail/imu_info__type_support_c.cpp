...
#include "realsense_camera_msgs/msg/detail/imu_info__rosidl_typesupport_fastrtps_c.h"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = realsense_camera_msgs__msg__IMUInfo;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const realsense_camera_msgs__msg__IMUInfo * ros_message = static_cast<const realsense_camera_msgs__msg__IMUInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_realsense_camera_msgs__msg__IMUInfo(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  realsense_camera_msgs__msg__IMUInfo * ros_message = static_cast<realsense_camera_msgs__msg__IMUInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_realsense_camera_msgs__msg__IMUInfo(cdr, ros_message);
}
...
static size_t _IMUInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_realsense_camera_msgs__msg__IMUInfo(
