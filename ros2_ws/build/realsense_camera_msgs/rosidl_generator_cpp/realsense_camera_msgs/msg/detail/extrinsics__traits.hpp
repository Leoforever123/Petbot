...
#ifndef REALSENSE_CAMERA_MSGS__MSG__DETAIL__EXTRINSICS__TRAITS_HPP_
#define REALSENSE_CAMERA_MSGS__MSG__DETAIL__EXTRINSICS__TRAITS_HPP_
...
[[deprecated("use realsense_camera_msgs::msg::to_block_style_yaml() instead")]]
inline void to_yaml(
  const realsense_camera_msgs::msg::Extrinsics & msg,
  std::ostream & out, size_t indentation = 0)
{
  realsense_camera_msgs::msg::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use realsense_camera_msgs::msg::to_yaml() instead")]]
inline std::string to_yaml(const realsense_camera_msgs::msg::Extrinsics & msg)
{
  return realsense_camera_msgs::msg::to_yaml(msg);
}
...
template<>
inline const char * name<realsense_camera_msgs::msg::Extrinsics>()
{
  return "realsense_camera_msgs/msg/Extrinsics";
}
...
template<>
struct is_message<realsense_camera_msgs::msg::Extrinsics>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // REALSENSE_CAMERA_MSGS__MSG__DETAIL__EXTRINSICS__TRAITS_HPP_
