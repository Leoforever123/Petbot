...
#include "realsense_camera_msgs/msg/detail/imu_info__type_support.h"
...
static const _IMUInfo_type_support_symbol_names_t _IMUInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, realsense_camera_msgs, msg, IMUInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, realsense_camera_msgs, msg, IMUInfo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, realsense_camera_msgs, msg, IMUInfo)() {
  return &::realsense_camera_msgs::msg::rosidl_typesupport_c::IMUInfo_message_type_support_handle;
}
