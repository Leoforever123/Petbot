...
#ifndef REALSENSE_CAMERA_MSGS__MSG__DETAIL__IMU_INFO__TRAITS_HPP_
#define REALSENSE_CAMERA_MSGS__MSG__DETAIL__IMU_INFO__TRAITS_HPP_
...
inline void to_yaml(
  const realsense_camera_msgs::msg::IMUInfo & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const realsense_camera_msgs::msg::IMUInfo & msg)
{
...
template<>
inline const char * name<realsense_camera_msgs::msg::IMUInfo>()
{
  return "realsense_camera_msgs/msg/IMUInfo";
}
...
template<>
struct is_message<realsense_camera_msgs::msg::IMUInfo>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // REALSENSE_CAMERA_MSGS__MSG__DETAIL__IMU_INFO__TRAITS_HPP_
